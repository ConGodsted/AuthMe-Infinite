...
public class AuthScreen extends Screen
{
    ...
    protected void init()
    {
        ...
        // Username Text Field
        usernameField = new TextFieldWidget(MinecraftClient.getInstance().textRenderer,
                width / 2 - 100,
                76,
                200,
                20,
        ...
        // Password Text Field
        passwordField = new PasswordFieldWidget(MinecraftClient.getInstance().textRenderer,
                width / 2 - 100,
                116,
                200,
                20,
    ...
    public void render(int mouseX, int mouseY, float delta)
    {
        ...
        drawCenteredString(MinecraftClient.getInstance().textRenderer, title.asFormattedString(), width / 2, 17, 16777215);
        drawCenteredString(MinecraftClient.getInstance().textRenderer, greeting.asFormattedString(), width / 2, 34, 16777215);

        if (message != null)
            drawCenteredString(MinecraftClient.getInstance().textRenderer, message.asFormattedString(), width / 2, height / 4 + 86, 16777215);

        drawString(MinecraftClient.getInstance().textRenderer, I18n.translate("gui.authme.auth.field.username"), width / 2 - 100, 64, 10526880);
        drawString(MinecraftClient.getInstance().textRenderer, I18n.translate("gui.authme.auth.field.password"), width / 2 - 100, 104, 10526880);
